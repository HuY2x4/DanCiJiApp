...
public class Kanyixuanci_ku extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kanyixuanci_ku);
        setfind();
        GONGNENGNOW = 2;
        Log.w("Hyx", "1号-1");
        ckset();
        ...
        if (USERNAME.equals("")) {
            ...
            kanyi_count.setVisibility(View.INVISIBLE);
        }
        fanhui.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(Kanyixuanci_ku.this, Zhuye.class);
        ...
        chenji.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GONGNENGNOW = 2;
                Intent intent = new Intent(Kanyixuanci_ku.this, Chenji.class);
                startActivity(intent);
            }
        });
        ...
        pointck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countPoDC_clear();
                Intent intentP = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            public void onClick(View v) {
                ...
                if (siliuji == 4) {
                    if (num.equals(maxnum4)) {
                        Toast.makeText(Kanyixuanci_ku.this, "最后一页！", Toast.LENGTH_SHORT).show();
                    } else {
                        next();
                    }
                } else if (siliuji == 6) {
        ...
        shang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String num = ck1.getText().toString();
                if (num.equals("1")) {
                    Toast.makeText(Kanyixuanci_ku.this, "已经是第一页！", Toast.LENGTH_SHORT).show();
                } else {
                    xianShi();
                    last();
                }
    ...
    public void setfind() {
        biaoti=(TextView) findViewById(R.id.kanyiXCK_biaoti);
        kanyi_count = (TextView) findViewById(R.id.kanyiXCK_count);
        fanhui = (Button) findViewById(R.id.kanyiXCK_fanhui);
        shang = (Button) findViewById(R.id.kanyiXCK_shang);
        xia = (Button) findViewById(R.id.kanyiXCK_xia);
        chenji = (Button) findViewById(R.id.kanyiXCK_chenji);
        pointck = (Button) findViewById(R.id.kanyiXCK_point);
        ck1 = (Button) findViewById(R.id.kanyiXCK_ck1);
        ck2 = (Button) findViewById(R.id.kanyiXCK_ck2);
        ck3 = (Button) findViewById(R.id.kanyiXCK_ck3);
        ck4 = (Button) findViewById(R.id.kanyiXCK_ck4);
        ck5 = (Button) findViewById(R.id.kanyiXCK_ck5);
        ck6 = (Button) findViewById(R.id.kanyiXCK_ck6);
        ck7 = (Button) findViewById(R.id.kanyiXCK_ck7);
        ck8 = (Button) findViewById(R.id.kanyiXCK_ck8);
        ck9 = (Button) findViewById(R.id.kanyiXCK_ck9);
        ck10 = (Button) findViewById(R.id.kanyiXCK_ck10);
        ck11 = (Button) findViewById(R.id.kanyiXCK_ck11);
        ck12 = (Button) findViewById(R.id.kanyiXCK_ck12);
        ck13 = (Button) findViewById(R.id.kanyiXCK_ck13);
        ck14 = (Button) findViewById(R.id.kanyiXCK_ck14);
        ck15 = (Button) findViewById(R.id.kanyiXCK_ck15);
        ck16 = (Button) findViewById(R.id.kanyiXCK_ck16);
        ck17 = (Button) findViewById(R.id.kanyiXCK_ck17);
        ck18 = (Button) findViewById(R.id.kanyiXCK_ck18);
        ck19 = (Button) findViewById(R.id.kanyiXCK_ck19);
        ck20 = (Button) findViewById(R.id.kanyiXCK_ck20);
        list.add(ck1);
        list.add(ck2);
        list.add(ck3);
        list.add(ck4);
    ...
    public void onClick(View v) {
        ...
        switch (tag) {
            case 1:
                ...
                Intent intent1 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 2:
                ...
                Intent intent2 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 3:
                ...
                Intent intent3 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 4:
                ...
                Intent intent4 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 5:
                ...
                Intent intent5 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 6:
                ...
                Intent intent6 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 7:
                ...
                Intent intent7 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 8:
                ...
                Intent intent8 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 9:
                ...
                Intent intent9 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 10:
                ...
                Intent intent10 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 11:
                ...
                Intent intent11 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 12:
                ...
                Intent intent12 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 13:
                ...
                Intent intent13 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 14:
                ...
                Intent intent14 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 15:
                ...
                Intent intent15 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 16:
                ...
                Intent intent16 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 17:
                ...
                Intent intent17 = new Intent(Kanyixuanci_ku.this, Kuaisujiyi.class);
            ...
            case 18:
                ...
                Intent intent18 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 19:
                ...
                Intent intent19 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
            ...
            case 20:
                ...
                Intent intent20 = new Intent(Kanyixuanci_ku.this, Kanyixuanci.class);
                    ...
                    if (msg.what == 0x12) {
                        ...
                        try {
                            ...
                            if (count.equals("0")) {
                                ...
                                if(!USERNAME.equals("")){
                                    kanyi_count.setVisibility(View.VISIBLE);
                                    kanyi_count.setText(count);
                                }
