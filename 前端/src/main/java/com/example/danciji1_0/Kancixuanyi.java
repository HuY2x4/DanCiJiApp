...
public class Kancixuanyi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kancixuanyi);
        ...
        SpeechUtility.createUtility( Kancixuanyi.this, SpeechConstant.APPID + "=5b1d13aa"); //初始化
        ZhuDC= (TextView) findViewById(R.id.kanciGN_danci);
        voice= (Button) findViewById(R.id.kanciGN_voice);
        kqwSpeechCompound=new KqwSpeechCompound(this);
        voice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                kqwSpeechCompound.setParam();
                kqwSpeechCompound.speaking(ZhuDC.getText().toString().trim());
            }
        });        //合成语音
        ...
        zhuye.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                returnZhuye();//改颜色
                Intent intent =new Intent(Kancixuanyi.this,Zhuye.class);
        ...
        xia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(if_point==0){
                    if(dcxh==20){
                        Toast.makeText(Kancixuanyi.this,"该词库全部记忆完成",Toast.LENGTH_LONG).show();
                        for(int i=0;i<20;i++){
                            zongfen+=fenshu[i];
                        }
                        updFenshu();
        ...
        shang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(if_point==0){
                    if(dcxh==1){
                        Toast.makeText(Kancixuanyi.this,"当前是第一页！",Toast.LENGTH_LONG).show();
        ...
        A.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(A_jieshi.getText().toString().equals(ZhuDC.getText().toString())){
                    xianshiJS();
                    A.setBackgroundColor(Color.parseColor("#33c930"));//绿色0x33c930
                    fenshu[dcxh-1]=5;
                }
                else{
                    if(mark.getText().toString().equals("mark")){
                    ...
                    xianshiJS();
                    A.setBackgroundColor(Color.parseColor("#8c8585"));//灰色0x8c8585
    ...
    public void setfind(){
        zhuye=(Button)findViewById(R.id.kanciGN_zhuye);
        shang=(Button)findViewById(R.id.kanciGN_shang);
        xia=(Button)findViewById(R.id.kanciGN_xia);
        mark=(Button)findViewById(R.id.kanciGN_mark);
        number=(TextView)findViewById(R.id.kanciGN_number);
        ZhuDC=(TextView)findViewById(R.id.kanciGN_danci);
        A=(Button)findViewById(R.id.kanciGN_A);
        B=(Button)findViewById(R.id.kanciGN_B);
        C=(Button)findViewById(R.id.kanciGN_C);
        D=(Button)findViewById(R.id.kanciGN_D);
        A_jieshi=(TextView)findViewById(R.id.kanciGN_A_jieshi);
        B_jieshi=(TextView)findViewById(R.id.kanciGN_B_jieshi);
        C_jieshi=(TextView)findViewById(R.id.kanciGN_C_jieshi);
        D_jieshi=(TextView)findViewById(R.id.kanciGN_D_jieshi);
                    ...
                    if (msg.what==0x12){
                        ...
                        try {
                            ...
                            if(result.equals("fail")){
                                Toast.makeText(Kancixuanyi.this,"颜色记录失败",Toast.LENGTH_LONG).show();
                            }
                    ...
                    if (msg.what==0x12){
                        ...
                        try {
                            ...
                            for (int i = 0; i < lst.size(); i++) {
                                if(i==0){
                                    A_jieshi.setText(lst.get(i).substring(0,lst.get(i).indexOf("?")));
                                    A.setText(lst.get(i).substring(lst.get(i).indexOf("?")+1));
                                }
                                else if(i==1){
                                    B_jieshi.setText(lst.get(i).substring(0,lst.get(i).indexOf("?")));
                                    B.setText(lst.get(i).substring(lst.get(i).indexOf("?")+1));
                                }
                                else if(i==2){
                                    C_jieshi.setText(lst.get(i).substring(0,lst.get(i).indexOf("?")));
                                    C.setText(lst.get(i).substring(lst.get(i).indexOf("?")+1));
                                }
                                else if(i==3){
                                    D_jieshi.setText(lst.get(i).substring(0,lst.get(i).indexOf("?")));
                                    D.setText(lst.get(i).substring(lst.get(i).indexOf("?")+1));
                                }
                            }
                    ...
                    if (msg.what==0x12){
                        ...
                        try {
                            ...
                            if(result.equals("success")){
                                ...
                                Toast.makeText(Kancixuanyi.this,"已存在于重点词库中",Toast.LENGTH_SHORT).show();
                            }
