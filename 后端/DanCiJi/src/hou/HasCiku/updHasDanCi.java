 ...
 */
@WebServlet("/updHasDanCi")
public class updHasDanCi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        yanse =Integer.parseInt(request.getParameter("yanse"));
        xiaociku =Integer.parseInt(request.getParameter("xiaociku"));
        String result = "";
        //数据库函数获取!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       
        hasDC hasdc=new hasDC();
        hasdc.updHasDC(name, gongneng, siliuji, xiaociku, yanse);
        result="success";
        //数据库函数获取!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
