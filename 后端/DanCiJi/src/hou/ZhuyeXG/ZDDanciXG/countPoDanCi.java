 ...
 */
@WebServlet("/countPoDanCi")
public class countPoDanCi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    DCciku = Integer.parseInt(request.getParameter("DCciku"));
        
        String count = "";
        //数据库函数获取!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       PointwordContr pointwordcontr=new PointwordContr();
       count=Integer.toString(pointwordcontr.count(name,DCciku));
     ...
     //   URLEncoder.encode(result1,"utf-8");
        ...
        jsonObject.put("count", count);//这里注意也要改
